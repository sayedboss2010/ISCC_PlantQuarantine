...
namespace PlantQuar.API.Controllers.Import.Im_Committee
{
    ...
    public class ImCommittee_Final_Result_APIController : ApiController
    {
        ImCommittee_Final_ResultBLL cBLL = new ImCommittee_Final_ResultBLL();
        ...
        public HttpResponseMessage Insert_Lot_Result(int Lot_Result, Im_CheckRequest_Items_Lot_ResultDTO Lot_ResultList)
        {
            try
            {
        ...
        public HttpResponseMessage Insert_Im_CheckRequest_Visa(int Visa_ID, Im_CheckRequest_VisaDTO CheckRequest_VisaDList)
        {
        ...
        public HttpResponseMessage Insert_Im_CheckRequest_Final_Result(int Im_CheckRequest_Final_Result, Im_CheckRequest_Final_ResultDTO Im_CheckRequest_Final_ResultList)
        {
            //add committee results
            try
            {

...
namespace PlantQuar.API.Controllers.Shipping
{
    ...
    public class Im_Visa_Data_APIController : ApiController
    {
        // GET: Im_Visa_Data_API
        Im_Visa_DataBLL cBLL = new Im_Visa_DataBLL();
        ...
        //}
        public HttpResponseMessage GetIm_Visa_DataList(int pageSize, int index)
        {
            try
            {
        ...
        public HttpResponseMessage GetIm_Visa_Data(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/Im_Visa_Data/PostCreateIm_Visa_Data
        public HttpResponseMessage PostCreateIm_Visa_Data(Im_Visa_DataDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateIm_Visa_Data(Im_Visa_DataDTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeleteIm_Visa_Data(int delete, DeleteParameters Dto)
        {
            //Delete            
            try
            {

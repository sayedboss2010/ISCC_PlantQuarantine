using PlantQuar.BLL.BLL.Export_CheckRequest_New;
...
namespace PlantQuar.API.Controllers.Export_CheckRequest_New
{
    public class EX_Committee_Final_Result_Quick_APIController : ApiController
    {
        EX_Committee_Final_Result_QuickBLL cBLL = new EX_Committee_Final_Result_QuickBLL();
        ...
        public HttpResponseMessage Insert_EX_CheckRequest_Visa(int Visa_ID, EX_CheckRequest_VisaDTO CheckRequest_VisaDList)
        {
        ...
        public HttpResponseMessage Insert_EX_CheckRequest_Final_Result(int EX_CheckRequest_Final_Result, EX_CheckRequest_Final_ResultDTO EX_CheckRequest_Final_ResultList)
        {
            //add committee results
            try
            {
        ...
        public HttpResponseMessage GetDelete_Emp_Confirm(long Committee_ID, long Employee_ID, short UserId)
        {
            try
            {
        ...
        public HttpResponseMessage GetFarmsData(long Ex_CheckRequest_ID)
        {
            try
            {
                Dictionary<string, object> dic = cBLL.GetAll_FarmsData(Ex_CheckRequest_ID, API_HelperFunctions.Get_DeviceInfo());
                return Request.CreateResponse(API_HelperFunctions.getStatusCode(int.Parse(dic["state_Code"].ToString())), dic["obj"]);

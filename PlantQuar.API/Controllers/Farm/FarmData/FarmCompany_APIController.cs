...
namespace PlantQuar.API.Controllers.Farm.FarmData
{
    ...
    public class FarmCompany_APIController : ApiController
    {
        Farm_CompanyBLL cBLL = new Farm_CompanyBLL();
        public HttpResponseMessage GetFarm_CompanyCount()
        {
            try
            {
        ...
        public HttpResponseMessage PostCreateFarm_Company(Farm_CompanyDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateFarm_Company(Farm_CompanyDTO Dto)
        {
            //EDIT
            try
            {

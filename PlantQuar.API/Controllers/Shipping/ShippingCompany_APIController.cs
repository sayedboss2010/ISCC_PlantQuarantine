...
namespace PlantQuar.API.Controllers.Shipping
{
    ...
    public class ShippingCompany_APIController : ApiController
    {
        // GET: ShippingCompany_API
        ShippingCompanyBLL cBLL = new ShippingCompanyBLL();
        ...
        //}
        public HttpResponseMessage ShippingCompanyList(int pageSize, int index)
        {
            try
            {
        ...
        public HttpResponseMessage GetShippingCompanyName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/ShippingCompany/PostCreateShippingCompany
        public HttpResponseMessage PostCreateShippingCompany(ShippingCompanyDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateShippingCompany(ShippingCompanyDTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeleteShippingCompany(int delete, DeleteParameters Dto)
        {
            //Delete            
            try
            {

...
namespace PlantQuar.API.Controllers.Station
{
    ...
    public class Station_Constrain_Type_APIController : ApiController
    {
        Station_Constrain_TypeBLL cBLL = new Station_Constrain_TypeBLL();


        public HttpResponseMessage GetStation_Constrain_TypeCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetStation_Constrain_TypeList(int pageSize, int index )
        {
            try
            {
        ...
        // GET: api/Station_Constrain_Type/GetStation_Constrain_TypeName
        public HttpResponseMessage GetStation_Constrain_TypeName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/Station_Constrain_Type/PostCreateStation_Constrain_Type
        public HttpResponseMessage PostCreateStation_Constrain_Type(Station_Constrain_TypeDTO Dto )
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateStation_Constrain_Type(Station_Constrain_TypeDTO Dto )
        {
            //EDIT
            try
            {
       Dictionary<string, object> dic = cBLL.Update(Dto, API_HelperFunctions.Get_DeviceInfo());
        ...
        public HttpResponseMessage PutDeleteStation_Constrain_Type(int delete, DeleteParameters Dto )
        {
            //Delete            
            try
            {
        ...
        public HttpResponseMessage GetStation_Constrain_Type_List(int List )
        {
            try
            {
        ...
        public HttpResponseMessage GetStation_Constrain_Type_AddEdit(int AddEdit )
        {
            try
            {

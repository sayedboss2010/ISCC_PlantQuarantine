...
namespace PlantQuar.API.Controllers.Station
{
    ...
    public class StationActivty_APIController : ApiController
    {
        ...
        //DROPS
        public HttpResponseMessage GetStationActivity_List(int List)
        {
            try
            {
        ...
        public HttpResponseMessage GetStationActivity_AddEdit(int AddEdit)
        {
            try
            {

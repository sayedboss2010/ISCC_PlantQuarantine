...
namespace PlantQuar.API.Controllers.Station
{
    ...
    public class Station_CheckList_Constrain_APIController : ApiController
    {
        Station_CheckList_ConstrainBLL cBLL = new Station_CheckList_ConstrainBLL();
        ...
        public HttpResponseMessage PostCreateCenters(Station_CheckList_Constrain_DTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateCenters(Station_CheckList_Constrain_DTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage GetBy_Station_Constrain_TypeId(long Station_Constrain_Country_Item_ID, bool Android_ID)
        {
            try
            {
                Dictionary<string, object> dic = cBLL.GetBy_Station_Constrain_TypeId(Station_Constrain_Country_Item_ID, Android_ID, API_HelperFunctions.Get_DeviceInfo());
                return Request.CreateResponse(API_HelperFunctions.getStatusCode(int.Parse(dic["state_Code"].ToString())), dic["obj"]);
            }
            catch (Exception ex)
            {

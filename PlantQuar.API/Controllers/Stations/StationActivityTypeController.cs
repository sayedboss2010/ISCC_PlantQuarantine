...
namespace PlantQuar.API.Controllers.Stations
{
    ...
    public class StationActivityTypeController : ApiController
    {
        StationActivityTypeBLL cBLL = new StationActivityTypeBLL();
        public HttpResponseMessage GetStationActivityTypeCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetStationActivityTypeList(int pageSize, int index )
        {
            try
            {
Dictionary<string, object> dic = cBLL.GetAll( pageSize, index, API_HelperFunctions.Get_DeviceInfo());
        ...
        // GET: api/StationActivityType/GetAStationActivityTypeName
        public HttpResponseMessage GetAStationActivityTypeName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/StationActivityType/PostCreateStationActivityType
        public HttpResponseMessage PostCreateStationActivityType(StationActivityTypeDTO Dto )
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateStationActivityType(StationActivityTypeDTO Dto )
        {
            //EDIT
            try
            {
       Dictionary<string, object> dic = cBLL.Update(Dto, API_HelperFunctions.Get_DeviceInfo());
        ...
        public HttpResponseMessage PutDeleteStationActivityType(int delete, DeleteParameters obj)
        {
            //Delete            
            try
            {
        ...
        public HttpResponseMessage GetIsTreatment(int ActID)
        {
            var check = cBLL.IsTreatment(ActID);
            return Request.CreateResponse(HttpStatusCode.OK, check);
        }
        public HttpResponseMessage GetStationActivityType_List(int List )
        {
            try
            {
        ...
        public HttpResponseMessage GetStationActivityType_AddEdit(int AddEdit )
        {
            try
            {

...
namespace PlantQuar.API.Controllers.DataEntry.LookUp
{
    ...
    public class ContactType_APIController : ApiController
    {
        ContactTypeBLL cBLL = new ContactTypeBLL();
        //ContactTypeBLL<ContactTypeDTO> cBLL = new ContactTypeBLL<ContactTypeDTO>();
        public HttpResponseMessage GetContactTypeCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetContactTypeList(int pageSize, int index )
        {
            try
            {
        ...
        // GET: api/ContactType/GetContactTypeName
        public HttpResponseMessage GetContactTypeName(string arName, string enName, int pageSize, int index, string jtSorting="")
        {
            try
            {
        ...
        //GET Insert A: api/ContactType/PostCreateContactType
        public HttpResponseMessage PostCreateContactType(ContactTypeDTO     Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateContactType(ContactTypeDTO     Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeleteContactType(int delete, DeleteParameters     Dto)
        {
            //Delete            
            try
            {
        ...
        public HttpResponseMessage GetContactType_List(int List )
        {
            try
            {
        ...
        public HttpResponseMessage GetContactType_ListALL(int all)
        {
            try
            {

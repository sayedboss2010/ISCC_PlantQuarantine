...
namespace PlantQuar.API.Controllers.DataEntry.Port
{
    ...
    public class PortOrganization_APIController : ApiController
    {
        PortOrganizationBLL cBLL = new PortOrganizationBLL();
        public HttpResponseMessage GetPortOrganizationCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetPortOrganizationList(int pageSize, int index )
        {
            try
            {
        ...
        // GET: api/PortOrganization/GetPortOrganizationName
        public HttpResponseMessage GetPortOrganizationName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/PortOrganization/PostCreatePortOrganization
        public HttpResponseMessage PostCreatePortOrganization(PortOrganizationDTO     Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdatePortOrganization(PortOrganizationDTO     Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeletePortOrganization(int delete, DeleteParameters     Dto)
        {
            //Delete            
            try
            {
        ...
        //DROPS
        public HttpResponseMessage GetPortOrganization_List(int List )
        {
            try
            {
        ...
        public HttpResponseMessage GetPortOrganization_AddEdit(int AddEdit)
        {
            try
            {

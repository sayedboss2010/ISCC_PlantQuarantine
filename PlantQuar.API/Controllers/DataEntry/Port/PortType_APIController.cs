...
namespace PlantQuar.API.Controllers.DataEntry.Port
{
    ...
    public class PortType_APIController : ApiController
    {
        PortTypeBLL cBLL = new PortTypeBLL();

        public HttpResponseMessage GetPortTypeCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetPortTypeList(int pageSize, int index )
        {
            try
            {
        ...
        // GET: api/PortType/GetPortTypeName
        public HttpResponseMessage GetPortTypeName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/PortType/PostCreatePortType
        public HttpResponseMessage PostCreatePortType(Port_TypeDTO     Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdatePortType(Port_TypeDTO     Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeletePortType(int delete, DeleteParameters     Dto)
        {
            //Delete            
            try
            {
        ...
        //DROPS
        public HttpResponseMessage GetPortType_List(int List )
        {
            try
            {
        ...
        public HttpResponseMessage GetPortType_AddEdit(int AddEdit)
        {
            try
            {

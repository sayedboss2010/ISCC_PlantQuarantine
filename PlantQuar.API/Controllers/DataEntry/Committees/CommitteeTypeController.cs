using PlantQuar.BLL.BLL.DataEntry.Committees;
...
namespace PlantQuar.API.Controllers.DataEntry.Committees
{
    [EnableCors(origins: "*", headers: "*", methods: "*")]
    public class CommitteeTypeController : ApiController
    {

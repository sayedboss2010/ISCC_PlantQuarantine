...
namespace PlantQuar.API.Controllers.DataEntry.Countries
{
    ...
    public class Union_APIController : ApiController
    {
        UnionBLL cBLL = new UnionBLL();
        public HttpResponseMessage GetUnionCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetUnionList(int pageSize, int index)
        {
            try
            {
        ...
        // GET: api/Union/GetUnionName
        public HttpResponseMessage GetUnionName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/Union/PostCreateUnion
        public HttpResponseMessage PostCreateUnion(UnionDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateUnion(UnionDTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeleteUnion(int delete, DeleteParameters Dto)
        {
            //Delete            
            try
            {
        ...
        //DROPS
        public HttpResponseMessage GetUnion_List(int List)
        {
            try
            {
        ...
        public HttpResponseMessage GetUnion_AddEdit(int AddEdit)
        {
            try
            {

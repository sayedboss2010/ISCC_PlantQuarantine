...
namespace PlantQuar.API.Controllers.DataEntry.Countries
{
    ...
    public class RegionArea_APIController : ApiController
    {
        RegionAreaBLL cBLL = new RegionAreaBLL();
        public HttpResponseMessage GetRegionCount()
        {
            try
            {
        ...
        public HttpResponseMessage PostCreateRegion(Regional_AreaDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateRegion(Regional_AreaDTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage GetRegion_List(int List)
        {
            try
            {

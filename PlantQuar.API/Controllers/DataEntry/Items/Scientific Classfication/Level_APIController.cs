...
namespace PlantQuar.API.Controllers.DataEntry.Items.Scientific_Classfication
{
    ...
    public class Level_APIController : ApiController
    {
        LevelBLL cBLL = new LevelBLL();
        public HttpResponseMessage GetLevelCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetLevelList(int pageSize, int index)
        {
            try
            {
        ...
        // GET: api/Level/GetLevelName
        public HttpResponseMessage GetLevelName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/Level/PostCreateLevel
        public HttpResponseMessage PostCreateLevel(LevelDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateLevel(LevelDTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeleteLevel(int delete, DeleteParameters Dto)
        {
            //Delete            
            try
            {
        ...
        //DROPS
        public HttpResponseMessage GetLevel_List(int List)
        {
            try
            {
        ...
        public HttpResponseMessage GetLevel_AddEdit(int AddEdit)
        {
            try
            {

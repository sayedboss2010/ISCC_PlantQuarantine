...
namespace PlantQuar.API.Controllers.DataEntry.Items.Scientific_Classfication
{
    ...
    {
        OrderBLL cBLL = new OrderBLL();
        public HttpResponseMessage GetPlantOrderCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetPlantOrderList(int pageSize, int index)
        {
            try
            {
        ...
        // GET: api/PlantOrder/GetPlantOrderName
        //sort

        public HttpResponseMessage GetPlantOrderName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        //GET Insert A: api/PlantOrder/PostCreatePlantOrder
        public HttpResponseMessage PostCreatePlantOrder(OrderDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdatePlantOrder(OrderDTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeletePlantOrder(int delete, DeleteParameters Dto)
        {
            //Delete            
            try
            {
        ...
        //DROPS
        public HttpResponseMessage GetPlantOrder_List(int List)
        {
            try
            {
        ...
        public HttpResponseMessage GetPlantOrder_AddEdit(int AddEdit)
        {
            try
            {
        ...
        public HttpResponseMessage GetPlantOrderListParam(int List, int Phylum_ID)
        {
            try
            {
                List<string> device_data = API_HelperFunctions.Get_DeviceInfo();
                Dictionary<string, object> dic = cBLL.GetAllUsingParamForList(Phylum_ID, device_data);
                //for android group
                if (!bool.Parse(device_data[1]))
                {
                    //android
        ...
        public HttpResponseMessage GetPlantOrderADDEDITParam(int AddEdit, int Phylum_ID)
        {
            try
            {
                Dictionary<string, object> dic = cBLL.GetAllUsingParamForAddEdit(Phylum_ID, API_HelperFunctions.Get_DeviceInfo());
                return Request.CreateResponse(API_HelperFunctions.getStatusCode(int.Parse(dic["state_Code"].ToString())), dic["obj"]);
            }
            catch (Exception ex)
            {

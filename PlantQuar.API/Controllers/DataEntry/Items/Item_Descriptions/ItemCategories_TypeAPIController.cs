...
namespace PlantQuar.API.Controllers.DataEntry.Items.Item_Descriptions
{
    ...
    public class ItemCategories_TypeAPIController : ApiController
    {
        ItemCategories_TypeBLL cBLL = new ItemCategories_TypeBLL();

        public HttpResponseMessage GetItemCategoryTypeCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetItemCategoryTypeList(int pageSize, int index)
        {
            try
            {
        ...
        public HttpResponseMessage GetItemCategoryTypeName(string arName, string enName, int pageSize, int index, string jtSorting)
        {
            try
            {
        ...
        public HttpResponseMessage PostCreateItemCategoryType(ItemCategories_TypeDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdateItemCategoryType(ItemCategories_TypeDTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeleteItemCategoryType(int delete, DeleteParameters Dto)
        {
            //Delete            
            try
            {
        ...
        //DROPS
        public HttpResponseMessage GetItemCategoryType_List(int List)
        {
            try
            {
        ...
        public HttpResponseMessage GetItemCategoryType_AddEdit(int AddEdit)
        {
            try
            {

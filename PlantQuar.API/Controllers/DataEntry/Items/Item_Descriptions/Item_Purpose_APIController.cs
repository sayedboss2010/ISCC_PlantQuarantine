...
namespace PlantQuar.API.Controllers.DataEntry.Items.Item_Descriptions
{
    [EnableCors(origins: "*", headers: "*", methods: "*")]

    public class Item_Purpose_APIController : ApiController
    {
        Item_PurposeBLL cBLL = new Item_PurposeBLL();
        public HttpResponseMessage GetItem_PurposeCount()
        {
            try
            {
        ...
        public HttpResponseMessage GetPlantPurposeList(int pageSize, int index)
        {
            try
            {
        ...
        // GET: api/PlantPurpose/GetPlantPurposeName
        public HttpResponseMessage GetPlantPurposeName(string arName, string enName, int pageSize, int index)
        {
            try
            {
        ...
        //GET Insert A: api/PlantPurpose/PostCreatePlantPurpose
        public HttpResponseMessage PostCreatePlantPurpose(Item_PurposeDTO Dto)
        {
            //Create
            try
            {
        ...
        public HttpResponseMessage PutUpdatePlantPurpose(Item_PurposeDTO Dto)
        {
            //EDIT
            try
            {
        ...
        public HttpResponseMessage PutDeletePlantPurpose(int delete, DeleteParameters Dto)
        {
            //Delete            
            try
            {
        ...
        //DROPS
        public HttpResponseMessage GetPlantPurpose_List(int List)
        {
            try
            {
        ...
        public HttpResponseMessage GetPlantPurpose_AddEdit(int AddEdit)
        {
            try
            {

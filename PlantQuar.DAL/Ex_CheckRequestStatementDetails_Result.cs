...
namespace PlantQuar.DAL
{
    ...
    public partial class Ex_CheckRequestStatementDetails_Result
    {
        ...
        public Nullable<short> StationGovernmentId { get; set; }
        public string StationGovernment { get; set; }
        public Nullable<short> StationCenterId { get; set; }

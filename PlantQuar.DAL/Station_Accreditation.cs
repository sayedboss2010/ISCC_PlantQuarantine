...
namespace PlantQuar.DAL
{
    ...
    public partial class Station_Accreditation
    {
        ...
        public Station_Accreditation()
        {
            this.StationCompanies = new HashSet<StationCompany>();
        }
    
        public long ID { get; set; }
        public long Station_ID { get; set; }
        public long Station_Accreditation_Data_ID { get; set; }
        public Nullable<long> Station_Accreditation_Request_ID { get; set; }
        ...
        public virtual ICollection<StationCompany> StationCompanies { get; set; }
    }
}

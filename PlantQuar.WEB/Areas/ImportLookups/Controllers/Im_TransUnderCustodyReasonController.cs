...
{
    public class Im_TransUnderCustodyReasonController : BaseController
    {
        string apiName = "Im_TransUnderCustodyReason_API";

        // GET: ImportLookups/Im_TransUnderCustodyReason
        ...
        //LOAD SEARCH
        [HttpPost]
        public JsonResult listIm_TransUnderCustodyReason
        (string txt_AR_BTNSearch = null, string txt_EN_BTNSearch = null, int jtStartIndex = 0, int jtPageSize = 0, string jtSorting = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    APIHandeling.Insert_Error( Request.Url.AbsoluteUri.ToString(), ex.Message, "listIm_TransUnderCustodyReason");
        ...
        //Insert
        [HttpPost]
        public JsonResult CreateIm_TransUnderCustodyReason(Im_TransUnderCustodyReasonDTO model)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    APIHandeling.Insert_Error( Request.Url.AbsoluteUri.ToString(), ex.Message, "CreateIm_TransUnderCustodyReason");
                    return Json(new { Result = "ERROR", Message = Enums.GetEnumDescription<Enums.Error>(Enums.Error.ErrorHappened) });
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult UpdateIm_TransUnderCustodyReason(Im_TransUnderCustodyReasonDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [HttpPost]
        public JsonResult DeleteIm_TransUnderCustodyReason(byte ID)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    APIHandeling.Insert_Error( Request.Url.AbsoluteUri.ToString(), ex.Message, "DeletelistIm_TransUnderCustodyReason");
                    return Json(new { Result = "ERROR", Message = Enums.GetEnumDescription<Enums.Error>(Enums.Error.ErrorHappened) });
                }
            }
        }

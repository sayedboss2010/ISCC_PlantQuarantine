...
{
    public class ImProcedureTypeController : BaseController
    {
        // GET: ImportLookups/ImportProcedures
        string apiName = "Im_ProcedureType";

        // GET: Im_Stores/Im_Stores
        ...
        //LOAD SEARCH
        [HttpPost]
        public JsonResult listIm_ProcedureType
        ...
        //Insert
        [HttpPost]
        public JsonResult CreateIm_ProcedureType(Im_ProcedureTypeDTO model)
        {
            try
            {
            ...
            //    else
            //    {
            //        APIHandeling.Insert_Error( Request.Url.AbsoluteUri.ToString(), ex.Message, "CreateIm_Stores");
            //        return Json(new { Result = "ERROR", Message = Enums.GetEnumDescription<Enums.Error>(Enums.Error.ErrorHappened) });
            //    }
            //}
        }
        ...
        //UPDATE
        [HttpPost]
        public JsonResult UpdateIm_ProcedureType(Im_ProcedureTypeDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        //DELETE
        [HttpPost]
        public JsonResult DeleteIm_ProcedureType(int ID)
        {
            try
            {

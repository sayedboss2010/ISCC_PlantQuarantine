...
{
    public class FreeZonesController : BaseController
    {

        string apiName = "FreeZone_API";

        // GET: ImportLookups/FreeZones
        ...
        //LOAD SEARCH
        [HttpPost]
        public JsonResult ListFreeZone
        ...
        [HttpPost]
        public JsonResult CreateFreeZone(FreeZoneDTO model)
        {
            try
            {
        ...
        //  UPDATE
        [HttpPost]
        public JsonResult UpdateFreeZone(FreeZoneDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [HttpPost]
        public JsonResult DeleteFreeZone(byte ID)
        {
            try
            {
        ...
        public JsonResult Gov_List()
        {
            try
            {
                var res = APIHandeling.getData("Governate?List=1");

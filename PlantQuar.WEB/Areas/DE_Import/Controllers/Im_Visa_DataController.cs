...
{
    public class Im_Visa_DataController : BaseController
    {
        // GET: DE_Import/Im_Visa_Data
        string apiName = "Im_Visa_Data_API";
        public ActionResult Index()
        {
            return View();
        }
        [HttpGet]
        public ActionResult AllIm_VisaExcell()
        {
            var res = APIHandeling.getData(apiName + "?pageSize=-1&index=-1");

            var lst = res.Content.ReadAsAsync<List<Im_Visa_DataDTO>>().Result;//object
        ...
        //LOAD SEARCH
        [HttpPost]
        public JsonResult listIm_Visas
        (string txt_AR_BTNSearch = "", string txt_EN_BTNSearch = "", int jtStartIndex = 0, int jtPageSize = 0, string jtSorting = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                else
                {
                    ...
                    APIHandeling.Insert_Error(Request.Url.AbsoluteUri.ToString(), ex.Message, "listIm_Visas");
        ...
        //Insert
        [HttpPost]
        public JsonResult CreateIm_Visas(Im_Visa_DataDTO model)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    APIHandeling.Insert_Error(Request.Url.AbsoluteUri.ToString(), ex.Message, "CreateIm_Visa");
                    return Json(new { Result = "ERROR", Message = Enums.GetEnumDescription<Enums.Error>(Enums.Error.ErrorHappened) });
                }
            }
        }
        ...
        //UPDATE
        [HttpPost]
        public JsonResult UpdateIm_Visas(Im_Visa_DataDTO model)
        {
            try
            {
                if (ModelState.IsValid)
            ...
            catch (Exception ex)
            {
                ...
                {
                    APIHandeling.Insert_Error(Request.Url.AbsoluteUri.ToString(), ex.Message, "UpdateIm_Visa");
                    return Json(new { Result = "ERROR", Message = Enums.GetEnumDescription<Enums.Error>(Enums.Error.ErrorHappened) });
                }
            }
        }
        ...
        //DELETE
        [HttpPost]
        public JsonResult DeleteIm_Visas(Int16 ID)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    APIHandeling.Insert_Error(Request.Url.AbsoluteUri.ToString(), ex.Message, "DeleteIm_Visas");
                    return Json(new { Result = "ERROR", Message = Enums.GetEnumDescription<Enums.Error>(Enums.Error.ErrorHappened) });
                }
            }
        }
        //check code
        [HttpPost]
        public JsonResult GetIm_VisaOptions()
        {
            try
            {
                var res = APIHandeling.getData(apiName + "?IsActive=1");
                var lst = res.Content.ReadAsAsync<List<Im_Visa_DataDTO>>().Result;
                var Im_Visas = lst.Select(c => new { DisplayText = c.Ar_Name, Value = c.ID, }).OrderBy(s => s.DisplayText);

                return Json(new { Result = "OK", Options = Im_Visas });
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Visa_AddEDIT()
        {
            try
            {
                ...
                var res = APIHandeling.getData("Im_Visa_Data_API?VisaAddEdit=1");

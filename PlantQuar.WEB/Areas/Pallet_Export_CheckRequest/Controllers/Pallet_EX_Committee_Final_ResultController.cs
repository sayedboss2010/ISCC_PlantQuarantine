...
{
    public class Pallet_EX_Committee_Final_ResultController : BaseController
    {
        //Pallet_Export_CheckRequest/Pallet_EX_Committee_Final_Result
        string api = "Pallet_EX_Committee_Final_Result_API";
        ...
        public ActionResult Index(long? requestId, long? OutLet_ID, long? item_ShortName_ID = null, long? Lots_itemShortName_ID = null, long? CommitteeTypeLst_ID = null)
        {
            ...
            //}
            var resItem = APIHandeling.getData("Pallet_EX_Committee_Final_Result_API?EX_CheckRequest_Number=" + requestId + "&item_ShortName_ID=" + item_ShortName_ID + "&Lots_itemShortName_ID=" + Lots_itemShortName_ID + "&CommitteeTypeLst_ID=" + CommitteeTypeLst_ID);
            var Lst = resItem.Content.ReadAsAsync<Pallet_EX_Committee_Final_ResultDTO>().Result;
        ...
        public JsonResult ItemShortName_AddEDIT()
        {
            try
            {
                ...
                var res = APIHandeling.getData("Pallet_EX_Committee_Final_Result_API?ItemShortNameAddEdit=" + req);
        ...
        public JsonResult ItemLotName_AddEDIT(long ItemShortName_ID)
        {
            ...
            {
                var req = Session["requestId"];
                var res = APIHandeling.getData("Pallet_EX_Committee_Final_Result_API?Req=" + req + "&ItemShortNameID=" + ItemShortName_ID);
        ...
        public JsonResult SearchProducts(long itemShortName, long lots_itemShortName)
        {
            try
            {
                ...
                var resItem = APIHandeling.getData("Pallet_EX_Committee_Final_Result_API?EX_CheckRequest_Number=" + req + "&item_ShortName_ID=" + itemShortName);
            ...
            {
                APIHandeling.Insert_Error(Request.Url.AbsoluteUri.ToString(), ex.Message, "Pallet_EX_Committee_Final_ResultController");
                return Json(new { Result = "ERROR", Message = Enums.GetEnumDescription<Enums.Error>(Enums.Error.ErrorHappened) });
            }
        }

        [HttpPost]
        public JsonResult Insert_Lot_Result(long Lot_Category_ID, int IS_Status, string Nots, Pallet_EX_CheckRequest_Items_Lot_ResultDTO Lot_ResultList)
        {
            try
            {
                ...
                {
                    var res = APIHandeling.Post("Pallet_EX_Committee_Final_Result_API" + "?Lot_Result=1", Lot_ResultList);
        ...
        public JsonResult Insert_EX_CheckRequest_Final_Result(int EX_Final_Result_ID, Pallet_EX_CheckRequest_Final_ResultDTO
            Final_Result_List)
        {
            try
            {
                ...
                {
                    var res = APIHandeling.Post("Pallet_EX_Committee_Final_Result_API" + "?EX_CheckRequest_Final_Result=1", Final_Result_List);
        ...
        public JsonResult Insert_EX_CheckRequest_Visa(long Visa_ID, Pallet_EX_CheckRequest_VisaDTO CheckRequest_VisaList)
        {
            try
            {
                var allErrors = ModelState.Values.SelectMany(x => x.Errors).ToList();
                ...
                {
                    var res = APIHandeling.Post("Pallet_EX_Committee_Final_Result_API" + "?Visa_ID=1", CheckRequest_VisaList);
        ...
        public JsonResult VisaLabResult_AddEDIT(int VisaResult)
        {
            try
            {
                ...
                var lst = res.Content.ReadAsAsync<Pallet_EX_Visa_DataDTO>().Result;
        ...
        public JsonResult Update_Status_Confirm(long Status_Id, bool Status_Bool)
        {
            try
            {
                ...
                var userId = (short)Session["UserId"];
                var res = APIHandeling.getData("Pallet_EX_Committee_Final_Result_API" + "?Status_Id=" + Status_Id + "&Status=" + Status_Bool);
        ...
        public JsonResult Visa_AddEDIT()
        {
            try
            {
                ...
                var res = APIHandeling.getData("Pallet_EX_Committee_Final_Result_API?VisaAddEdit=1");
        ...
        public JsonResult GetPR_User_Id(string FullName, long EmplyeeNo, long OutLet_ID)
        {
            try
            {
                var Fees_Process = APIHandeling.getData("Pallet_EX_Committee_Final_Result_API?FullName=" + FullName + "&EmplyeeNo=" + EmplyeeNo + "&OutLet_ID=" + OutLet_ID);

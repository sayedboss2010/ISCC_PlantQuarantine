...
{
    public class CompanyActivityTypeController : BaseController
    {
        // GET: CO_Company/CompanyActivityType
        string apiName = "CompanyActivityType_API";

        // GET: Companies/CompanyActivityType
        ...
        //Insert
        [HttpPost]
        public JsonResult CreateTBLRows(CompanyActivityTypeDTO model)
        {
            try
            {
        ...
        [HttpPost]
        public JsonResult UpdateTBLRows(CompanyActivityTypeDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [HttpPost]
        public JsonResult DeletelistTBLRows(byte ID)
        {
            try
            {

...
{
    public class Enrollment_typeController : BaseController
    {
        // GET: CO_Company/Enrollment_type
        string apiName = "Enrollment_type_API";
        ...
        //LOAD SEARCH
        [HttpPost]
        public JsonResult listEnrollment_type
        ...
        //Insert
        [HttpPost]
        public JsonResult CreateEnrollment_type(Enrollment_typeDTO model)
        {
            try
            {
        ...
        //UPDATE
        [HttpPost]
        public JsonResult UpdateEnrollment_type(Enrollment_typeDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        //DELETE
        [HttpPost]
        public JsonResult DeleteEnrollment_type(byte ID)
        {
            try
            {
        ...
        //eman
        public JsonResult Enrollment_type_AddEDIT()
        {
            try
            {
                var res = APIHandeling.getData("Enrollment_type_API?AddEdit=1");

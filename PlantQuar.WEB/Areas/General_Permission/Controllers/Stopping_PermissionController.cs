...
{
    public class Stopping_PermissionController : Controller
    {
        // GET: General_Permission/Stopping_Permission
        public ActionResult Index()
        {
            return View();
        }
        [HttpPost]
        public JsonResult GetPermissionsList(long? ImPermission_Number, int Isacceppted,int? OperationCode=1)
        {
            var res = APIHandeling.getData("General_Stopping_PermissionAPI?List=1&ImPermission_Number=" + ImPermission_Number+ "&OperationCode="+ OperationCode);
        ...
        [HttpPost]
        public JsonResult UpdateUserDatal(ActivePrintDto activePrintDto, int? OperationCode = 1)
        {
            try
            {
                ...
                var res = APIHandeling.Put("General_Stopping_PermissionAPI", activePrintDto);

...
namespace PlantQuar.Web.Areas.Stations.Controllers
{
    public class StationAccreditationController :BaseController
    {
        ...
        // GET: Stations/StationAccreditation
        string apiName = "StationAccreditation";
        [HttpPost]
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if ((int)data.StatusCode != 409)
                    {
                        ...
                        {
                            APIHandeling.Post("StationAccreditationTreatment?user_id=" + user_id + "&Date_Now=" + Date_Now.ToString("yyyy-MM-dd hh:mm:ss") +
                        ...
                        {
                            APIHandeling.Post("StationAccreditationCountry?user_id=" + user_id + "&Date_Now=" + Date_Now.ToString("yyyy-MM-dd hh:mm:ss") + "&StationAccreditationID=" + StationAccreditationID, CountryDto);
                        }
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if ((int)data.StatusCode != 409)
                    {
                        ...
                        APIHandeling.Put("StationAccreditationTreatment?user_id=" + user_id + "&Date_Now=" + Date_Now.ToString("yyyy-MM-dd hh:mm:ss") + "&StationAccreditationID=" + model.ID + "&Treatment_Id="+ Treatment_Id, "");
                        ...
                        if (CountryDto.Count != 0)
                        {
                            APIHandeling.Put("StationAccreditationCountry?user_id=" + user_id + "&Date_Now=" + Date_Now.ToString("yyyy-MM-dd hh:mm:ss") + "&StationAccreditationID=" + model.ID, CountryDto);
                        }
        ...
        public JsonResult IsTreatment(int ActID=0)
        {
            try
            {
                ...
                var res = APIHandeling.getData("StationActivityType?ActID=" + ActID);

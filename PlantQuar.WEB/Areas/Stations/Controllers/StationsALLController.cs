...
namespace PlantQuar.Web.Areas.Stations.Controllers
{
    ...
    {
        //CHECK CODE
        // GET: Stations/StationsALL//
        string apiName = "Station";
        string apiName_StationPlantProduct = "StationPlantProduct";
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if ((int)data.StatusCode != 409)
                    {
                        ...
                        APIHandeling.Post("StationContact?user_id=" + user_id + "&Date_Now=" + Date_Now.ToString("yyyy-MM-dd hh:mm:ss") + "&StationID=" + StationID, Contacts);
        ...
        public JsonResult UpdateStation(StationDTO model, HttpPostedFileBase Picture1)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    APIHandeling.Put("StationContact?user_id=" + user_id + "&Date_Now=" + Date_Now.ToString("yyyy-MM-dd hh:mm:ss") + "&StationID=" + StationID, model.Contacts);
        ...
        public JsonResult GetContactList(int StationId)
        {
            try
            {
                ...
                var res = APIHandeling.getData("StationContact?StationID=" + StationId);

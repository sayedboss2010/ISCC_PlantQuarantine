...
{
    public class EX_Committee_Final_Result_QuickController : BaseController
    {
        // GET: Export_CheckRequest_New/EX_Committee_Final_Result_Quick
        string api = "EX_Committee_Final_Result_Quick_API";
        ...
        public ActionResult Index(long? requestId, long? OutLet_ID, long? item_ShortName_ID = null, long? Lots_itemShortName_ID = null, long? CommitteeTypeLst_ID = null)
        {
            ...
            //}
            var resItem = APIHandeling.getData("EX_Committee_Final_Result_Quick_API?EX_CheckRequest_Number=" + requestId + "&item_ShortName_ID=" + item_ShortName_ID + "&Lots_itemShortName_ID=" + Lots_itemShortName_ID + "&CommitteeTypeLst_ID=" + CommitteeTypeLst_ID);
            var Lst = resItem.Content.ReadAsAsync<EX_Committee_Final_Result_QuickDTO>().Result;
        ...
        public JsonResult ItemShortName_AddEDIT()
        {
            try
            {
                ...
                var res = APIHandeling.getData("EX_Committee_Final_Result_Quick_API?ItemShortNameAddEdit=" + req);
        ...
        public JsonResult ItemLotName_AddEDIT(long ItemShortName_ID)
        {
            ...
            {
                var req = Session["requestId"];
                var res = APIHandeling.getData("EX_Committee_Final_Result_Quick_API?Req=" + req + "&ItemShortNameID=" + ItemShortName_ID);
        ...
        public JsonResult SearchProducts(long itemShortName, long lots_itemShortName)
        {
            try
            {
                ...
                var resItem = APIHandeling.getData("EX_Committee_Final_Result_Quick_API?EX_CheckRequest_Number=" + req + "&item_ShortName_ID=" + itemShortName);
        ...
        public JsonResult Insert_Lot_Result(long Lot_Category_ID, int IS_Status, string Nots, EX_CheckRequest_Items_Lot_ResultDTO Lot_ResultList)
        {
            try
            {
                ...
                {
                    var res = APIHandeling.Post("EX_Committee_Final_Result_Quick_API" + "?Lot_Result=1", Lot_ResultList);
            ...
            Final_Result_List)
        {
            try
            {
                ...
                {
                    var res = APIHandeling.Post("EX_Committee_Final_Result_Quick_API" + "?EX_CheckRequest_Final_Result=1", Final_Result_List);
        ...
        public JsonResult Insert_EX_CheckRequest_Visa(long Visa_ID, EX_CheckRequest_VisaDTO CheckRequest_VisaList)
        {
            try
            {
                ...
                {
                    var res = APIHandeling.Post("EX_Committee_Final_Result_Quick_API" + "?Visa_ID=1", CheckRequest_VisaList);
        ...
        public JsonResult Update_Status_Confirm(long Status_Id, bool Status_Bool)
        {
            try
            {
                ...
                var userId = (short)Session["UserId"];
                var res = APIHandeling.getData("EX_Committee_Final_Result_Quick_API" + "?Status_Id=" + Status_Id + "&Status=" + Status_Bool);
        ...
        public JsonResult Visa_AddEDIT()
        {
            try
            {
                ...
                var res = APIHandeling.getData("EX_Committee_Final_Result_Quick_API?VisaAddEdit=1");
        ...
        public JsonResult GetPR_User_Id(string FullName, long EmplyeeNo, long OutLet_ID)
        {
            try
            {
                var Fees_Process = APIHandeling.getData("EX_Committee_Final_Result_Quick_API?FullName=" + FullName + "&EmplyeeNo=" + EmplyeeNo + "&OutLet_ID=" + OutLet_ID);
        ...
        public JsonResult Delete_Emp_Confirm(long Committee_ID, long Employee_ID)
        {
            ...
            {
                var userId = (short)Session["UserId"];
                var res = APIHandeling.getData("EX_Committee_Final_Result_Quick_API?Committee_ID=" + Committee_ID + "&Employee_ID=" + Employee_ID + "&UserId=" + userId);
                var data = res.Content.ReadAsAsync<CommitteeEmployeeDTO>().Result;

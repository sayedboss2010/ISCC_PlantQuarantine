...
{
    public class ExCommittee_Final_ResultController : BaseController
    {
        // GET: Export_CheckRequest/ExCommittee_Final_Result
        string api = "ExCommittee_Final_Result_API";
        ...
        public ActionResult Index(long? requestId, long? OutLet_ID, long? item_ShortName_ID = null, long? Lots_itemShortName_ID = null, long? CommitteeTypeLst_ID = null)
        {
            ...
            //}
            var resItem = APIHandeling.getData("ExCommittee_Final_Result_API?ImCheckRequest_Number=" + requestId + "&item_ShortName_ID=" + item_ShortName_ID + "&Lots_itemShortName_ID=" + Lots_itemShortName_ID + "&CommitteeTypeLst_ID=" + CommitteeTypeLst_ID);
            var Lst = resItem.Content.ReadAsAsync<ExCommittee_Final_ResultDTO>().Result;
        ...
        public JsonResult ItemShortName_AddEDIT()
        {
            try
            {
                ...
                var res = APIHandeling.getData("ExCommittee_Final_Result_API?ItemShortNameAddEdit=" + req);
        ...
        public JsonResult ItemLotName_AddEDIT(long ItemShortName_ID)
        {
            ...
            {
                var req = Session["requestId"];
                var res = APIHandeling.getData("ExCommittee_Final_Result_API?Req=" + req + "&ItemShortNameID=" + ItemShortName_ID);
        ...
        public JsonResult SearchProducts(long itemShortName, long lots_itemShortName)
        {
            try
            {
                ...
                var resItem = APIHandeling.getData("ExCommittee_Final_Result_API?ImCheckRequest_Number=" + req + "&item_ShortName_ID=" + itemShortName);
        ...
        [HttpPost]
        public JsonResult Insert_Lot_Result(long Lot_Category_ID,bool IS_Status, string Nots, EX_CheckRequest_Items_Lot_ResultDTO Lot_ResultList)
        {
            try
            {
                ...
                {
                    var res = APIHandeling.Post("ExCommittee_Final_Result_API" + "?Lot_Result=1", Lot_ResultList);
        ...
        public JsonResult Insert_Im_CheckRequest_Final_Result(int Im_Final_Result_ID,Ex_CheckRequest_Final_ResultDTO Final_Result_List)
        {
            try
            {
                var allErrors = ModelState.Values.SelectMany(x => x.Errors).ToList();
              ...
              //  var CheckRequest_Final_ResultList = new List<Im_CheckRequest_Final_ResultDTO>();
                ...
                {
                    var res = APIHandeling.Post("ExCommittee_Final_Result_API" + "?Im_CheckRequest_Final_Result=1", Final_Result_List);
        ...
        public JsonResult Insert_Im_CheckRequest_Visa(long Visa_ID ,Ex_CheckRequest_VisaDTO CheckRequest_VisaList)
        {
            try
            {
                var allErrors = ModelState.Values.SelectMany(x => x.Errors).ToList();
                ...
                {
                    var res = APIHandeling.Post("ExCommittee_Final_Result_API" + "?Visa_ID=1", CheckRequest_VisaList);

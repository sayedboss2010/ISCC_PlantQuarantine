...
{
    public class CheckRequestChangeLotController : BaseController
    {
        // GET: Export_CheckRequest/CheckRequestChangeLot
        string apiName = "CheckRequestChangeLot_API";
        ...
        public JsonResult GetGeshniCommittee(string CheckRequestNumber)
        {
            try
            {
                ...
                var lst = res.Content.ReadAsAsync<List<CheckRequestChangeLotDTO>>().Result;
        ...
        public JsonResult GetNewPortGeshni(LotWeightDTO LotWeight )
        {
            try
            {
                ...
                // var res = APIHandeling.Post("CheckRequestChangeLot_API", geshniPortsLst);
        ...
        ///
        [HttpPost]
        public JsonResult CheckRequestChangeWeightList( string CheckRequest_Number,
   List<CheckedItemsListWeightDTO> CheckedItemsListWeight
 )
        {
            if (CheckedItemsListWeight != null)
             {
                ...
                CheckedItemsListWeight.FirstOrDefault().User_Updation_Id = (short)Session["UserId"];
                CheckedItemsListWeight.FirstOrDefault().User_Updation_Date = DateTime.Now;

                string Mess = "ok";
                var res2 = APIHandeling.Put(apiName + "?CheckRequest_Number="+ CheckRequest_Number, CheckedItemsListWeight);

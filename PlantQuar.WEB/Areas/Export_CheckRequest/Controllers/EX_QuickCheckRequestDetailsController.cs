...
{
    public class EX_QuickCheckRequestDetailsController : BaseController
    {
        // GET: Export_CheckRequest/EX_QuickCheckRequestDetails
        ...
        public ActionResult Index(string ImCheckRequest_Number, long? Station_Examination_ID, long? Outlet_Examination_ID, long? Outlet_Genshi_ID, long? Station_Genshi_ID, int Hide_Button = 0)
        {
            ...
            var res = APIHandeling.getData("EX_QuickCheckRequestDetails_API?ExCheckRequest_Number=" + ImCheckRequest_Number);
    
            var Lst = res.Content.ReadAsAsync<List<EXRequestDetailsDTO>>().Result;

            var reasons = APIHandeling.getData("EX_QuickCheckRequestDetails_API?List=1&refuse=1");
        ...
        public ActionResult saveReasons(List<short> listIDs, long checkReqId, string rejreasons_text)
        {
            ...
            APIHandeling.Post("EX_QuickCheckRequestDetails_API?listt=1", dto);
            return Json("succ");
        }

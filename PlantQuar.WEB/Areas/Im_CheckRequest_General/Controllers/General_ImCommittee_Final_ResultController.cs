...
{
    public class General_ImCommittee_Final_ResultController : BaseController
    {
        // GET: Im_CheckRequest_General/General_ImCommittee_Final_Result
        string api = "General_ImCommittee_Final_Result_API"; 
        public ActionResult Index(long? requestId, long? OutLet_ID, long? item_ShortName_ID = null, long? Lots_itemShortName_ID = null, long? CommitteeTypeLst_ID = null)
        {
            ...
            //}
            var resItem = APIHandeling.getData("General_ImCommittee_Final_Result_API?ImCheckRequest_Number=" + requestId + "&item_ShortName_ID=" + item_ShortName_ID + "&Lots_itemShortName_ID=" + Lots_itemShortName_ID + "&CommitteeTypeLst_ID=" + CommitteeTypeLst_ID);
            var Lst = resItem.Content.ReadAsAsync<General_ImCommittee_Final_ResultDTO>().Result;
        ...
        public JsonResult ItemShortName_AddEDIT()
        {
            try
            {
                ...
                var res = APIHandeling.getData("General_ImCommittee_Final_Result_API?ItemShortNameAddEdit=" + req);
        ...
        public JsonResult ItemLotName_AddEDIT(long ItemShortName_ID)
        {
            ...
            {
                var req = Session["requestId"];
                var res = APIHandeling.getData("General_ImCommittee_Final_Result_API?Req=" + req + "&ItemShortNameID=" + ItemShortName_ID);
        ...
        public JsonResult SearchProducts(long itemShortName, long lots_itemShortName)
        {
            try
            {
                ...
                var resItem = APIHandeling.getData("General_ImCommittee_Final_Result_API?ImCheckRequest_Number=" + req + "&item_ShortName_ID=" + itemShortName);
                //  var res = APIHandeling.getData("General_ImCommittee_Final_Result_API?itemShortName=" + itemShortName +
        ...
        [HttpPost]
        public JsonResult Insert_Lot_Result(long Lot_Category_ID, int IS_Status, string Nots, General_Im_CheckRequest_Items_Lot_ResultDTO Lot_ResultList)
        {
            try
            {
                ...
                {
                    var res = APIHandeling.Post("General_ImCommittee_Final_Result_API" + "?Lot_Result=1", Lot_ResultList);
        ...
        public JsonResult Insert_Im_CheckRequest_Final_Result(int Im_Final_Result_ID, General_Im_CheckRequest_Final_ResultDTO  Final_Result_List)
        {
            try
            {
                var allErrors = ModelState.Values.SelectMany(x => x.Errors).ToList();
                ...
                {
                    var res = APIHandeling.Post("General_ImCommittee_Final_Result_API" + "?Im_CheckRequest_Final_Result=1", Final_Result_List);
        ...
        public JsonResult Insert_Im_CheckRequest_Visa(long Visa_ID, General_Im_CheckRequest_VisaDTO CheckRequest_VisaList)
        {
            try
            {
                var allErrors = ModelState.Values.SelectMany(x => x.Errors).ToList();
                ...
                {
                    var res = APIHandeling.Post("General_ImCommittee_Final_Result_API" + "?Visa_ID=1", CheckRequest_VisaList);
        ...
        public JsonResult VisaLabResult_AddEDIT(int VisaResult)
        {
            try
            {
                ...
                var lst = res.Content.ReadAsAsync<General_Im_Visa_DataDTO>().Result;
        ...
        public JsonResult Delete_Emp_Confirm(long Committee_ID, long Employee_ID)
        {
            ...
            {
                var userId = (short)Session["UserId"];
                var res = APIHandeling.getData("General_ImCommittee_Final_Result_API" + "?Committee_ID=" + Committee_ID + "&Employee_ID=" + Employee_ID + "&UserId=" + userId);
        ...
        public JsonResult Update_Status_Confirm(long Status_Id, bool Status_Bool)
        {
            try
            {
                ...
                var userId = (short)Session["UserId"];
                var res = APIHandeling.getData("General_ImCommittee_Final_Result_API" + "?Status_Id=" + Status_Id + "&Status=" + Status_Bool);
                var data = res.Content.ReadAsAsync<CommitteeEmployeeDTO>().Result;

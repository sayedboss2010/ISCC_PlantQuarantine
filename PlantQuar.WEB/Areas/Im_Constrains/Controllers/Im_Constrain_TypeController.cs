...
{
    public class Im_Constrain_TypeController : BaseController
    {
        // GET: Im_Constrains/Im_Constrain_Type
        string apiName = "Im_Constrain_Type_API";
        ...
        //LOAD SEARCH
        [HttpPost]
        public JsonResult listConstrainType
        ...
        //Insert
        [HttpPost]
        public JsonResult CreateConstrainType(Im_Constrain_TypeDTO model)
        {
            try
            {
        ...
        //UPDATE
        [HttpPost]
        public JsonResult UpdateConstrainType(Im_Constrain_TypeDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        //DELETE
        [HttpPost]
        public JsonResult DeleteConstrainType(byte ID)
        {
            try
            {

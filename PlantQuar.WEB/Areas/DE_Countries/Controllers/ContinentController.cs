...
namespace PlantQuar.WEB.Areas.DE_Countries.Controllers
{
    public class ContinentController : BaseController
    {
        ...
        // GET: DE_Countries/Continent
        string apiName = "Continent_API";
        ...
        [HttpGet]
        public ActionResult AllContinentExcell()
        {
            var res = APIHandeling.getData(apiName + "?pageSize=-1&index=-1");

            var lst = res.Content.ReadAsAsync<List<ContinentDTO>>().Result;//object
        ...
        [HttpPost]
        public JsonResult listContinent
        ...
        //Insert
        [HttpPost]
        public JsonResult CreateContinent(ContinentDTO model)
        {
            try
            {
        ...
        //UPDATE
        [HttpPost]
        public JsonResult UpdateContinent(ContinentDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        //DELETE
        [HttpPost]
        public JsonResult DeleteContinent(byte ID)
        {
            try
            {

...
namespace PlantQuar.WEB.Areas.Im_Permissions.Controllers
{
    ...
    {
        // GET: Im_Permissions/Im_permissionDetail
        public ActionResult Index(decimal? ImPermission_Number)
        {
            var res = APIHandeling.getData("ListIm_PermissionAPI?detail=1&ImPermission_Number=" + ImPermission_Number);
            var Lst = res.Content.ReadAsAsync<ImPermissionPrintDetailsDTO>().Result;
            //
              var res2 = APIHandeling.getData("ListIm_PermissionAPI?ImPermissionRequestId=" + ImPermission_Number);
            var Lst2 = res2.Content.ReadAsAsync<List<Im_Permission_RefuseReasonDTO>>().Result;

            var reasons = APIHandeling.getData("ListIm_PermissionAPI?List=1&refuse=1");
        ...
        {           
            int v = 1;
            var res = APIHandeling.getData("ListIm_PermissionAPI?id="+v1+"&detail1=" + v);
        ...
        {           
                ...
                APIHandeling.Post("ListIm_PermissionAPI?listt=1", dto);
        ...
        public ActionResult acceptRequest(long Im_PermissionRequest_Id )
        {
            ...
            APIHandeling.Put("ListIm_PermissionAPI?approve=1", model);
        ...
        public ActionResult Save_NoPaid( long Im_PermissionRequest_Id)
        {
            ...
            APIHandeling.Post("ListIm_PermissionAPI?NoPaid=1", dto);
            return Json("succ");
        }
    }
}
...
{
    public class PortInternationalController :BaseController
    {
        string apiName = "PortInternational_API";
        // GET: DE_Port/PortInternational
        public ActionResult Index()
        {
            return View();
        }
        [HttpGet]
        public ActionResult AllPortInternationalExcell()
        {
            var res = APIHandeling.getData(apiName + "?pageSize=-1&index=-1");

            var lst = res.Content.ReadAsAsync<List<PortInternationalDTO>>().Result;//object
        ...
        //Insert
        [HttpPost]
        public JsonResult CreateTBLRows(PortInternationalDTO model)
        {
            try
            {
        ...
        [HttpPost]
        public JsonResult UpdateTBLRows(PortInternationalDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [HttpPost]
        public JsonResult DeletelistTBLRows(int ID)
        {
            try
            {

...
{
    public class PortNationalController : BaseController
    {
        // GET: DE_Port/PortNational
        string apiName = "PortNational_API";
        ...
        [HttpGet]
        public ActionResult AllPortNationalExcell()
        {
            var res = APIHandeling.getData(apiName + "?pageSize=-1&index=-1");

            var lst = res.Content.ReadAsAsync<List<PortNationalDTO>>().Result;//object
        ...
        //LOAD SEARCH
        [HttpPost]
        public JsonResult listPortNational
        ...
        //Insert
        [HttpPost]
        public JsonResult CreatePortNational(PortNationalDTO model)
        {
            try
            {
        ...
        [HttpPost]
        public JsonResult UpdatePortNational(PortNationalDTO model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [HttpPost]
        public JsonResult DeletePortNational(int ID)
        {
            try
            {

...
namespace PlantQuar.WEB.API
{
    public class FileUpload_SaveDataController:ApiController
    {
        ...
        public string Get_Uplood_Imge(string ID_Column, HttpPostedFileBase file, string Name_Folder, string Type_Folder_save,string Request_Url)
        {
            try
            {
              ...
              //  var DomainPath = "10.10.91.15";//prodction
                ...
                string AllPath = "";
                string Path_year = Create_Year("\\plant\\" + Name_Folder + "\\" + Type_Folder_save);
            ...
            {
                APIHandeling.Insert_Error(Request_Url, ex.Message, "Get_Uplood_Imge");
                return null;
            }
        }

...
namespace PlantQuar.BLL.BLL.DataEntry.Committees
{

    public class CommitteeTypeBLL : IGenericBLL<CommitteeTypeDTO>
    {
        ...
        public Dictionary<string, object> Find(object Id, List<string> Device_Info)
        {
            try
            {
                ...
                var empDTO = Mapper.Map<CommitteeType, CommitteeTypeDTO>(entity);
        ...
        public Dictionary<string, object> GetAll(int pageSize, int index, List<string> Device_Info) 
        {
            try
            {
                ...
                var dataDTO = data.Select(Mapper.Map<CommitteeType, CommitteeTypeDTO>);
...

        {
            try
            {
                ...
                string lang = Device_Info[2];
                var dataDto = data.Skip(index).Take(pageSize).Select(Mapper.Map<CommitteeType, CommitteeTypeDTO>);

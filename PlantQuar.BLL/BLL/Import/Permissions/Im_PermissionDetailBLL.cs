...
namespace PlantQuar.BLL.BLL.Import.Permissions
{
    public class Im_PermissionDetailBLL
    {
        private UnitOfWork uow;
        PlantQuarantineEntities entities = new PlantQuarantineEntities();

        public Im_PermissionDetailBLL()
        {
            uow = new UnitOfWork();
        }
          ...
          (decimal? ImPermission_Number, List<string> Device_Info)
        {
            try
            {
                ...
                if (permissionDetail != null)
                {
                    ...
                    if (permissionDetail.ImporterType_Id == 6)
                    {
                        ...
                        if (compAct != null)
                        {
                            ...
                            var CompanyActivities_Details = (from ca in entities.CompanyActivities
                                                             ...
                                                             where ca.Company_ID == permissionDetail.Importer_ID
                                                             && ca.IsActive == true
                            ...
                            permissionDetail._CompanyActivitys = CompanyActivities_Details;
                            permissionDetail.ImporterContacts = uow.Repository<Ex_ContactData>()
                           .GetData().Include(f => f.ContactType).
                      Where(a => a.Exporter_ID == permissionDetail.Importer_ID && a.ExporterType_Id == 6).
                    ...
                    else if (permissionDetail.ImporterType_Id == 7)
                    {
                        ...
                        permissionDetail.ImporterContacts = uow.Repository<Ex_ContactData>()
                .GetData().Include(f => f.ContactType).
           Where(a => a.Exporter_ID == permissionDetail.Importer_ID && a.ExporterType_Id == 7).
           Select(a => new ContactTypeDTO
           {
               Name_Ar = (lang == "1" ? a.ContactType.Name_Ar : a.ContactType.Name_En),
               Value = a.Value
           ...
           //             permissionDetail.ImporterContacts = uow.Repository<Ex_ContactData>()
           //     .GetData().Include(f => f.ContactType).
           //Where(a => a.Exporter_ID == permissionDetail.Importer_ID && a.ExporterType_Id == 8).
           //Select(a => new ContactTypeDTO
           //{
           //    Name_Ar = (lang == "1" ? a.ContactType.Name_Ar : a.ContactType.Name_En),
           //    Value = a.Value
           //}).ToList();
                        ...
                        permissionDetail.ImporterContacts = uow.Repository<Person>()
                  .GetData().
             Where(a => a.ID == permissionDetail.Importer_ID ).
             Select(a => new ContactTypeDTO
             {
                 ...
                 Value = a.Phone
                    ...
                    Nullable<int> portArriveTypeId = null;
                    ...
                    if (portArrive != null)
                    {
                        ...
                        portArriveTypeId = portArrive.Port_Type_ID;
                    }
                    //        public string TransportPortNameType { get; set; }
                    // public string ArrivePortNameType { get; set; }
                    ...
                    permissionDetail.ArrivePortNameType = uow.Repository<Port_Type>().GetData().Where(m => m.ID == portArriveTypeId).FirstOrDefault().Name_Ar;

                    //transport port 
                    Nullable<int> portTransId = null;
                    Nullable<int> portTransTypeId = null;
                    ...
                    if (portTrans != null)
                    {
                        ...
                        portTransTypeId = portTrans.Port_Type_ID;
                    ...
                    //end
                    permissionDetail.TransportPortNameType = uow.Repository<Port_Type>().GetData().Where(m => m.ID == portTransTypeId).FirstOrDefault().Name_Ar;
                    ...
                    foreach (var itt in itemss)
                    {
                        ...
                        if (itemShortNameId != null)
                        {
                            ...
                            itt.ItemNameAr = lang == "1" ? itmname.Name_Ar : itmname.Name_En;
                            itt.ItemNameEn = itmname.Name_En;
                            itt.ScientificNameAr = lang == "1" ? itmname.Scientific_Name : itmname.Scientific_Name;
                        }
        ...
        private void ImPermission_Approve(long Im_PermissionRequest_ID, bool? IsAcceppted, short? User_Creation_Id, int Action_Nou = 0)
        {
            ...
            newLog.NOTS = _NOTS;
            newLog.User_Type_ID = 127;
            newLog.Type_log_ID = 135;

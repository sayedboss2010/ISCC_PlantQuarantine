...
{
    public class Stopping_PermissionBLL
    {
        private UnitOfWork uow;
        //dbPrivilageEntities entities1 = new dbPrivilageEntities();

        public Stopping_PermissionBLL()
        {
            uow = new UnitOfWork();
        }
        #region
        ...
        public Dictionary<string, object> GetImPermissionsList_filter_ActivePrint
          (long? ImPermission_Number, List<string> Device_Info)
        {
            try
            {
        ...
        public Dictionary<string, object> Update(ActivePrintDto dto, List<string> Device_Info)
        {
            ...
            try
            {
                var f = db.Im_PermissionRequest.FirstOrDefault(x => x.ImPermission_Number ==dto.ImPermission_Number);
                if (f != null)
                {
        ...
        public Dictionary<string, object> Update(ActivePrintDto dto, long? ImPermission_Number, List<string> Device_Info)
        {
           PlantQuarantineEntities db = new PlantQuarantineEntities();

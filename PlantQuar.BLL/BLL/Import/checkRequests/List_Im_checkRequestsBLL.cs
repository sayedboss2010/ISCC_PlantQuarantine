...
{
    public class List_Im_checkRequestsBLL
    {
        private UnitOfWork uow;

        public List_Im_checkRequestsBLL()
        {
            uow = new UnitOfWork();
        }
       ...
       (short userId, long? outlet, string DateFrom, string DateEnd, int selectApproveId, int FinalResultListId
            , string CheckRequest_Number, long Company_ID , List<string> Device_Info)
        {
            try
            {
                ...
                paramters_Type.Add("DateFrom", SqlDbType.Date);
                paramters_Type.Add("DateEnd", SqlDbType.Date);
                //paramters_Type.Add("outlet_User", SqlDbType.BigInt);
                ...
                paramters_Data.Add("DateFrom", DateFrom.ToString());
                paramters_Data.Add("DateEnd", DateEnd.ToString());
                ...
                //End
                var requests = uow.Repository<ImCheckRequestListDTO>().CallStored("List_ImCheckRequest_Data", paramters_Type,
                paramters_Data, Device_Info).ToList();

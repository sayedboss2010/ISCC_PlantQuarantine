...
{
    public class ImCommittee_Final_ResultBLL
    {
        //xyza 
        ...
        public ImCommittee_Final_ResultBLL()
        {
            uow = new UnitOfWork();
        }
        ...
        public Dictionary<string, object> Insert_Lot_Result(Im_CheckRequest_Items_Lot_ResultDTO Lot_ResultList, List<string> Device_Info)
        {
            try
            {
                ...
                if (Lot_ResultList != null)
                {
                    ...
                    foreach (var item in checkResult_Fales)                 
                    {
                        ...
                        var Co = Mapper.Map<Im_CheckRequest_Items_Lot_ResultDTO, Im_CheckRequest_Items_Lot_Result>(Lot_ResultList);
        ...
        public Dictionary<string, object> Insert_Im_CheckRequest_Visa(Im_CheckRequest_VisaDTO CheckRequest_Visa, List<string> Device_Info)
        {
            try
            {
                if (CheckRequest_Visa != null)
                {
                    ...
                    //    item.im_RequestCommittee.ID = lotssss;
                    var Co = Mapper.Map<Im_CheckRequest_VisaDTO, Im_CheckRequest_Visa>(CheckRequest_Visa);
        ...
        public Dictionary<string, object> Insert_Im_CheckRequest_Final_Result(int Im_CheckRequest_Final_Result, Im_CheckRequest_Final_ResultDTO Im_CheckRequest_Final_ResultList, List<string> Device_Info)
        {
            try
            {
                if (Im_CheckRequest_Final_ResultList != null)
                {
                    ...
                    //    item.im_RequestCommittee.ID = lotssss;
                    var Co = Mapper.Map<Im_CheckRequest_Final_ResultDTO, Im_CheckRequest_Final_Result>(Im_CheckRequest_Final_ResultList);

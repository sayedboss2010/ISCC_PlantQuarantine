...
{
    public class EX_CheckRequestDetailsBLL
    {
        private UnitOfWork uow;

        public EX_CheckRequestDetailsBLL()
        {
            uow = new UnitOfWork();
        }
         ...
         (string EXCheckRequest_Number, List<string> Device_Info)
        {
            try
            {
                ...
                var CheckRequestDetails = uow.Repository<EXRequestDetailsDTO>().CallStored("Ex_CheckRequestDetails", paramters_Type,
                ...
                if (CheckRequestDetails.FirstOrDefault().IsAccepted == false)
                {
                    ...
                    //}
                    // uow.Repository<Ex_CheckRequest>().Where(a => a.Exporter_ID == check.Importer_ID && a.ExporterType_Id == 6).
                ...
                var Fees_Shift = (from sh in entities.Ex_RequestCommittee_Shift
                                  ...
                                  group sh by new
                                  {
                                      ...
                                      IsPaidCommitteeCondition = sh.Ex_RequestCommittee.IsPaid == true ? "تم الدفع " : "لم يتم الدفع",
                                  } into grp
                                  select new List_Shift
                                  {
                                      ...
                                      IsPaidCommitteeCondition = grp.Key.IsPaidCommitteeCondition,
                ...
                var Fees_Engineers = (from sh in entities.Ex_RequestCommittee_Fees_ENG
                                     ...
                                     && (sh.Ex_RequestCommittee.IsPaid == true || sh.Ex_RequestCommittee.Delegation_Date >= today)
                                      ...
                                      group sh by new
                                      {
                                          ...
                                          StartTime = sh.Ex_RequestCommittee.StartTime,
                                          EndTime = sh.Ex_RequestCommittee.EndTime,
                                          Is_Paid_Condition = sh.Ex_RequestCommittee.IsPaid == true ? "تم الدفع " : "لم يتم الدفع",
                                      } into grp
                                      select new List_ShiftEngineers
                                      {
                                          ...
                                          CommitteeType_ID = grp.Key.CommitteeType_ID,
                                          Is_Paid_Condition = grp.Key.Is_Paid_Condition,
                ...
                var Fees_Sample = (from sm in entities.Ex_CheckRequest_SampleData
                                  ...
                                  && (sm.Ex_RequestCommittee.IsPaid == true || sm.Ex_RequestCommittee.Delegation_Date >= today)
                                   ...
                                   group sm by new
                                   {
                                       ...
                                       //Is_Paid_SampleCondition = sm.Ex_RequestCommittee.IsPaid== true ? "تم الدفع " : "لم يتم الدفع",
                                   } into grp
                                   select new List_Sample
                                   {
                                       ...
                                       //Is_Paid_SampleCondition = grp.Key.Is_Paid_SampleCondition,
                                       Is_Paid_SampleCondition = grp.Key.Is_Paid_Sample2 == true ? "تم الدفع " : "لم يتم الدفع",
                ...
                var Fees_Treatment = (from rq in entities.Ex_RequestCommittee
                                     ...
                                     && rq.CommitteeType_ID == 6 && rq.Status == true
                                      ...
                                      select new List_Treatment
                                      {
                                          ...
                                          Is_Paid_TreatmentConition = grp.Key.Is_Paid_Treatment2 == true ? "تم الدفع " : "لم يتم الدفع",
                                      }).Distinct().ToList();

...
{
    public class ExCommittee_Final_ResultBLL
    {
        //xyza 
        ...
        public ExCommittee_Final_ResultBLL()
        {
            uow = new UnitOfWork();
        }
        ...
        //                                   select new ExCommittee_Final_ResultDTO
        //                                   {
        ...
        //                             && !(from o in entities.Im_CheckRequest_Items_Lot_Result
        //                                  select o.Im_CheckRequest_Items_Lot_Category_ID)
        //                          .Contains(lot.ID)
        //                               select lot.ID).Count();
        ...
        //                                  join Lot_R in entities.Im_CheckRequest_Items_Lot_Result on v.ID equals Lot_R.Im_CheckRequest_Items_Lot_Category_ID into cr
        //                                  from Lot_R in cr.DefaultIfEmpty()
        ...
        //                                      IS_Status_Lot_Result = Lot_R.IS_Status,
        //                                      Note_Lot_Result = Lot_R.Nots,
        //                                      //NOURA
        ...
        //                                         select new Committee_Result_Lot
        //                                         {
        ...
        //                                                     into emp_Conferm from rc in emp_Conferm.Where(a=>a.EmployeeId == CE.Employee_Id).DefaultIfEmpty()
        ...
        //                                                     select new Committee_Result_Lot_Conferm
        //                                                     {                                                                 
        //                                                         EmployeeId = CE.Employee_Id,
        //                                                         Notes = rc.Notes,
        //                                                         Date = rc.Date,
        ...
        //                                                       select new List_Im_CommitteeResult_Infection
        //                                                       {
        ...
        //                                                   select new List_AttachmentData_Im_CommitteeResult_Infection
        //                                                   {
        ...
        //                        item_Sample.list_Committee_Sample_Lot  = committee_Sample;
        //                    }
        //                }
        ...
        public Dictionary<string, object> FillItem_TypeDrop_Add(long req, List<string> Device_Info)
        {
            ...
            //data.Insert(0, new CustomOption() { DisplayText = "-----اختار المنتج-----", Value = null });
        ...
        public Dictionary<string, object> Insert_Lot_Result(EX_CheckRequest_Items_Lot_ResultDTO Lot_ResultList, List<string> Device_Info)
        {
            try
            {
                ...
                if (Lot_ResultList != null)
                {
                    ...
                    var Co = Mapper.Map<EX_CheckRequest_Items_Lot_ResultDTO, Im_CheckRequest_Items_Lot_Result>(Lot_ResultList);
        ...
        public Dictionary<string, object> Insert_Im_CheckRequest_Visa(Ex_CheckRequest_VisaDTO CheckRequest_Visa, List<string> Device_Info)
        {
            try
            {
                if (CheckRequest_Visa != null)
                {
                    ...
                    //    item.im_RequestCommittee.ID = lotssss;
                    var Co = Mapper.Map<Ex_CheckRequest_VisaDTO, Im_CheckRequest_Visa>(CheckRequest_Visa);
        ...
        public Dictionary<string, object> Insert_Im_CheckRequest_Final_Result(int Im_CheckRequest_Final_Result, Ex_CheckRequest_Final_ResultDTO Im_CheckRequest_Final_ResultList, List<string> Device_Info)
        {
            try
            {
                if (Im_CheckRequest_Final_ResultList != null)
                {
                    ...
                    //    item.im_RequestCommittee.ID = lotssss;
                    var Co = Mapper.Map<Ex_CheckRequest_Final_ResultDTO, Im_CheckRequest_Final_Result>(Im_CheckRequest_Final_ResultList);

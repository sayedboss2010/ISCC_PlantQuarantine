...
{
    public class Pallet_EX_Committee_Final_ResultBLL
    {
        //xyza 
        ...
        public Pallet_EX_Committee_Final_ResultBLL()
        {
            uow = new UnitOfWork();
        }
            ...
            long CommitteeTypeLst_ID, List<string> Device_Info)
        {
            try
            {
                ...
                var CheckRequestDetails = (from cc in entities.Ex_CheckRequest
                                           ...
                                           select new Pallet_EX_Committee_Final_ResultDTO
                                           {
        ...
        public Dictionary<string, object> Insert_Lot_Result(Pallet_EX_CheckRequest_Items_Lot_ResultDTO Lot_ResultList, List<string> Device_Info)
        {
            try
            {
                ...
                if (Lot_ResultList != null)
                {
                    ...
                    var Co = Mapper.Map<Pallet_EX_CheckRequest_Items_Lot_ResultDTO, Ex_CheckRequest_Items_Lot_Result>(Lot_ResultList);
        ...
        public Dictionary<string, object> Insert_EX_CheckRequest_Visa(Pallet_EX_CheckRequest_VisaDTO  CheckRequest_Visa, List<string> Device_Info)
        {
            try
            {
                if (CheckRequest_Visa != null)
                {
                    ...
                    //    item.im_RequestCommittee.ID = lotssss;
                    var Co = Mapper.Map<Pallet_EX_CheckRequest_VisaDTO, Ex_CheckRequest_Visa>(CheckRequest_Visa);
        ...
        public Dictionary<string, object> Insert_EX_CheckRequest_Final_Result(Pallet_EX_CheckRequest_Final_ResultDTO EX_CheckRequest_Final_ResultList, List<string> Device_Info)
        {
            try
            {
                if (EX_CheckRequest_Final_ResultList != null)
                {
                    ...
                    //    item.im_RequestCommittee.ID = lotssss;
                    var Co = Mapper.Map<Pallet_EX_CheckRequest_Final_ResultDTO, Ex_CheckRequest_Final_Result>(EX_CheckRequest_Final_ResultList);
        ...
        public Dictionary<string, object> FillVisaLabResultDrop_Edit(int VisaResult, List<string> Device_Info)
        {
            ...
            .Select(c => new Pallet_EX_Visa_DataDTO
            {
                ID = c.ID,
                Ar_Name = c.Ar_Name,

...
{
    public class ExportConstrainsNewBLL : IGenericBLL<Ex_CountryConstrainDTO>
    {
        private UnitOfWork uow;

        public ExportConstrainsNewBLL()
        {
            uow = new UnitOfWork();
        }
        ...
        public Dictionary<string, object> InsertCustomConstrain(CustomCountryConstrain constrains, List<string> Device_Info)
        {         
            try
            {

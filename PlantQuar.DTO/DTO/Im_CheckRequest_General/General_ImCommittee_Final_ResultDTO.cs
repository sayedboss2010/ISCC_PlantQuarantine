...
{
    public class General_ImCommittee_Final_ResultDTO
    {
        ...
        public List<General_CustomsMessage> CustomsMessages { get; set; }
        public List<General_Items_checkReq_New> itemsWithConstrains { get; set; }
        public List<General_FinalResult> FinalResults { get; set; }
        public List<General_CheckRequest_Visa> CheckRequest_Visa { get; set; }
    }
    public class General_Items_checkReq_New
    {
        ...
        public string subPartName { get; set; }
        public List<General_categories_lots_New> ItemCategories_lots { get; set; }

    }

    public class General_CustomsMessage
    {
    ...
    public class General_categories_lots_New
    {
        ...
        public List<General_Committee_Result_Lot> Lot_Committee_Result { get; set; }
        public List<General_Lot_Status_Result> Lot_Status_Result { get; set; }
        public List<General_Committee_Sample_Lot> List_Lot_Committee_Sample { get; set; }
        public List<General_List_Treatment_Data> List_Treatment { get; set; }



        public List<General_List_AttachmentData_Im_CommitteeResult_Infection> AttachmentData_Im_CommitteeResult_Infection { get; set; }
    }
    public class General_Lot_Status_Result
    {
    ...
    public class General_Committee_Result_Lot
    {
        //Eslam
        ...
        public Nullable<System.DateTime> Delegation_Date { get; set; }
        public List<General_Committee_Result_Lot_Conferm> List_Committee_Result_Conferm { get; set; }
        ...
        public List<General_List_Im_CommitteeResult_Infection> List_Im_CommitteeResult_Infection { get; set; }
    }

    public class General_Committee_Result_Lot_Conferm
    {
    ...
    public class General_Committee_Sample_Lot
    {
        public long ID { get; set; }
        ...
        public List<General_Committee_Sample_Conferm> List_Committee_Sample_Conferm { get; set; }
    ...
    public class General_Committee_Sample_Conferm
    {
        public Nullable<long> ID { get; set; }
    ...
    public class General_FinalResult
    {
        public Nullable<System.DateTime> DateFinalResult { get; set; }
        public Nullable<long> Im_CheckRequest_FinalResult_ID { get; set; }
        public Nullable<short> Final_Result_EmployeeId { get; set; }
    ...
    public class General_CheckRequest_Visa
    {
    ...
    public class General_Fees_ALL
    {
        public long ID { get; set; }
        public Nullable<decimal> Fees_CheckRequest { get; set; }
        public List<General_Fees_Item_ALL> Fees_Item_ALL { get; set; }
        public List<General_List_Shift> List_Shift { get; set; }
        public List<General_List_Sample> List_Sample { get; set; }
        public List<General_List_Treatment> List_Treatment { get; set; }
        public string Is_Paid_Check { get; set; }
    }
    public class General_Fees_Item_ALL
    {
        public long? ID { get; set; }
    ...
    //noura
    public class General_List_Shift
    {
        public long ID { get; set; }
    ...
    public class General_List_Sample
    {
        public long ID { get; set; }
    ...
    public class General_List_Treatment
    {
        public long ID { get; set; }
        public long Im_RequestCommittee_ID { get; set; }
        public long Im_Request_Item_Id { get; set; }
    ...
    public class General_List_Im_CommitteeResult_Infection
    {
        public long ID { get; set; }
    ...
    public class General_List_AttachmentData_Im_CommitteeResult_Infection
    {
        public long Id { get; set; }
    ...
    //treatment noura
    public class General_List_Treatment_Data
    {
        public long ID { get; set; }
        public Nullable<long> Committee_ID { get; set; }
        public long Im_RequestCommittee_ID { get; set; }
        ...
        public List<General_List_Treatment_Data_Confirm> List_Treatment_Confirm { get; set; }


    }
    public class General_List_Treatment_Data_Confirm
    {
        public Nullable<long> ID { get; set; }

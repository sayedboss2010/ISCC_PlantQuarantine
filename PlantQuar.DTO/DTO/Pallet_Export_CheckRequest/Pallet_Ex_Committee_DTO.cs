...
{
    public class  Pallet_Ex_Committee_DTO
    {
        ...
        public List<Pallet_EX_Items_checkReq_New> itemsWithConstrains { get; set; }
    }
    public class Pallet_Get_Ex_CountryConstrain_DTO
    {
        public int Count_Type_Commite { get; set; }
    }
    public class  Pallet_EX_RequestCommitteeDTO
    {
        ...
        public List<Pallet_EX_EmployeeDTO> com_emp { get; set; }

        public List<Pallet_EX_CommitteeResultDTO> List_CommitteeResult { get; set; }
        public List<Pallet_EX_CheckRequest_SampleDataDTO> List_SampleData { get; set; }
        public List<Pallet_EX_RequestCommittee_ShiftDTO> List_Committee_Shift { get; set; }
        public List<Pallet_EX_Checked_TreatmentMethodDTO> List_TreatmentMethod { get; set; }

    }

    public class  Pallet_EX_EmployeeDTO
    {
    ...
    public class  Pallet_EX_RequestCommittee_ShiftDTO
    {
        public long ID { get; set; }
    ...
    public class  Pallet_EX_CheckRequest_SampleDataDTO
    {
        public long ID { get; set; }
    ...
    public class  Pallet_EX_CommitteeResultDTO
    {
        public long ID { get; set; }
    ...
    public class  Pallet_EX_Checked_TreatmentMethodDTO
    {
        public long ID { get; set; }
        public long EX_RequestCommittee_ID { get; set; }
        public long EX_Request_Item_Id { get; set; }
    ...
    public class  Pallet_EX_CheckRequest_Committee_DTO
    {
        public long ID { get; set; }
    ...
    public class  Pallet_EX_Items_checkReq_New
    {
        public long? Item_ShortName_ID { get; set; }
        ...
        public List<Pallet_EX_categories_lots_New> ItemCategories_lots { get; set; }

    }

    public class  Pallet_EX_categories_lots_New
    {
        ...
        //public List<Pallet_Lots> categoryLots { get; set; }
        ...
        public List<Pallet_EX_Items_checkReq> Items_checkReq { get; set; }
        public List<Pallet_EX_Committee_Sample_Lot> list_Committee_Sample_Lot { get; set; }
        public List<Pallet_EX_Committee_Treatment_Lot> list_Committee_Treatment_Lot { get; set; }

        public List<Pallet_EX_Lot_Result_Status> list_Lot_Result_Status { get; set; }
        public long? EX_CommitteeResult_ID { get; set; }
        public Nullable<int> Lot_Result_Status { get; set; }


    }
    public class  Pallet_EX_Committee_Sample_Lot
    {
    ...
    public class  Pallet_EX_Committee_Treatment_Lot
    {
    ...
    public class  Pallet_EX_Lot_Result_Status
    {
    ...
    public class  Pallet_EX_Items_checkReq
    {
        public long ID { get; set; }
        public Nullable<long> Item_ShortName_ID { get; set; }
        ...
        public Pallet_EX_constrains Itemconstrains { get; set; }
        public Nullable<double> Size { get; set; }
        public Nullable<int> Package_Count { get; set; }
        public Nullable<decimal> Package_Weight { get; set; }
        public Nullable<int> Units_Number { get; set; }
        ...
        public List<Pallet_EX_categories_lots> ItemCategories_lots { get; set; }

    }
    public class  Pallet_EX_constrains
    {
    ...
    public class  Pallet_EX_categories_lots
    {
        public long ID { get; set; }
        public string packageMaterialName { get; set; }
        public string packageMaterial { get; set; }
    ...
    public class  Pallet_TreatmentMethodsDTO
    {
    ...
    public class  Pallet_TreatmentTypesDTO
    {
    ...
    public class  Pallet_TreatmentMainTypesDTO
    {
    ...
    public class  Pallet_AllTreatmentDataForShortnameIdDTO
    {

        public List<Pallet_TreatmentMethodsDTO> TreatmentMethodsDTO { get; set; }
        public List<Pallet_TreatmentTypesDTO> TreatmentTypesDTO { get; set; }
        public List<Pallet_TreatmentMainTypesDTO> TreatmentMainType { get; set; }

    }

    //noura
    public class  Pallet_Fees_ALL
    {
        public long ID { get; set; }
        public Nullable<decimal> Fees_CheckRequest { get; set; }
        public List<Pallet_Fees_Item_ALL> Fees_Item_ALL { get; set; }
        public List<Pallet_List_Shift> List_Shift { get; set; }
        public List<Pallet_List_Sample> List_Sample { get; set; }
        public List<Pallet_List_Treatment> List_Treatment { get; set; }
        public string Is_Paid_Check { get; set; }
    }
    public class  Pallet_Fees_Item_ALL
    {
        public long? ID { get; set; }
    ...
    public class  Pallet_List_Shift
    {
        public long ID { get; set; }
    ...
    public class  Pallet_List_Sample
    {
        public long ID { get; set; }
    ...
    public class  Pallet_List_Treatment
    {
        public long ID { get; set; }

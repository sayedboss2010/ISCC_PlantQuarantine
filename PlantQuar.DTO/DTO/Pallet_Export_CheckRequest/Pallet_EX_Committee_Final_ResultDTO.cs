...
{
    public class Pallet_EX_Committee_Final_ResultDTO
    {
        ...
        public List<EX_CustomsMessage> CustomsMessages { get; set; }
        public List<EX_Items_checkReq_New> itemsWithConstrains { get; set; }
        public List<EX_FinalResult> FinalResults { get; set; }
        public List<EX_Request_Visa> CheckRequest_Visa { get; set; }
    ...
    public class EX_CustomsMessage
    {
    ...
    public class EX_categories_lots_New
    {
        ...
        public List<EX_Committee_Result_Lot> Lot_Committee_Result { get; set; }
        public List<EX_Committee_Gashne_Result_Lot> Lot_Committee_Gashne_Result { get; set; }
        public List<EX_Lot_Status_Result> Lot_Status_Result { get; set; }
        public List<EX_Committee_Sample_Lot> List_Lot_Committee_Sample { get; set; }
        public List<List_Treatment_Data> List_Treatment { get; set; }



        public List<EX_List_AttachmentData_EX_CommitteeResult_Infection> AttachmentData_EX_CommitteeResult_Infection { get; set; }
    }
    public class EX_Lot_Status_Result
    {
    ...
    public class EX_Committee_Result_Lot
    {
        //Eslam
        ...
        public Nullable<System.DateTime> Delegation_Date { get; set; }
        public List<EX_Committee_Result_Lot_Conferm> List_Committee_Result_Conferm { get; set; }
        ...
        public List<EX_List_CommitteeResult_Infection> List_EX_CommitteeResult_Infection { get; set; }
    }
    public class EX_Committee_Gashne_Result_Lot
    {
        //Hadeer
        public long Committee_Result_Lot_ID { get; set; }
        public string ResultTypes_Name { get; set; }
    ...
    public class EX_Committee_Result_Lot_Conferm
    {
    ...
    public class EX_Committee_Sample_Lot
    {
        ...
        public List<EX_Committee_Sample_Conferm> List_Committee_Sample_Conferm { get; set; }
    ...
    public class EX_Committee_Sample_Conferm
    {
        public Nullable<long> ID { get; set; }
    ...
    public class EX_Fees_ALL
    {
        public long ID { get; set; }
        public Nullable<decimal> Fees_CheckRequest { get; set; }
        public List<EX_Fees_Item_ALL> Fees_Item_ALL { get; set; }
        public List<EX_List_Shift> EX_List_Shift { get; set; }
        public List<EX_List_Sample> EX_List_Sample { get; set; }
        public List<EX_List_Treatment> List_Treatment { get; set; }
        public string Is_Paid_Check { get; set; }
    }
    public class EX_Fees_Item_ALL
    {
        public long? ID { get; set; }
    ...
    public class EX_List_Treatment
    {
        public long ID { get; set; }
        public long EX_RequestCommittee_ID { get; set; }
        public long EX_Request_Item_Id { get; set; }
    ...
    public class EX_List_CommitteeResult_Infection
    {
        public long ID { get; set; }
    ...
    public class EX_List_AttachmentData_EX_CommitteeResult_Infection
    {
        public long Id { get; set; }
